...
namespace suil::secp256k1 {
    ...
    {
        if (mContext == nullptr) {
            throw Exception::create("failed to create secp256k1 context");
        }
    }
    ...
    {
        PrivateKey key;
        utils::bytes(str, &key[0], key.size());
    ...
    {
        PublicKey pub;
        utils::bytes(str, &pub[0], pub.size());
        secp256k1_pubkey _;
    ...
    {
        return !Ego.Private.nil() && !Ego.Public.nil();
    }
