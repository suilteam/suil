...
namespace suil::tmsp {
    ...
    struct Application : LOGGER(TMSP) {
        ...
        virtual void flush() {
            itrace("app::flush not implemented");
        }
